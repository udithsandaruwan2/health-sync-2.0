...
function AppointmentTable({ refreshKey, onRefresh }) {
  ...
  const [filterStatus, setFilterStatus] = useState(''); // State to store the filter status
  ...
  }, [id, refreshKey, filterStatus]); // Re-fetch appointments when refreshKey or filterStatus changes
